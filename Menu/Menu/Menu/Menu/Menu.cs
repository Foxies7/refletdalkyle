...
namespace Menu
{
    ...
    public class Menu : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            boutonNouveauJeu.Position = new Vector2(3 * sexyviolon / 4, 2 * sexysaxo / 10);
            ...
            boutonChargerDONTDOTHIS.Position = new Vector2(3 * sexyviolon / 4, 3 * sexysaxo / 10);
            ...
            boutonBonus.Position = new Vector2((3 * sexyviolon / 4), 4 * sexysaxo / 10);
            ...
            boutonOptions.Position = new Vector2(3 * sexyviolon / 4, 5 * sexysaxo / 10);
            ...
            boutonQuitter.Position = new Vector2(3 * sexyviolon / 4, 6 * sexysaxo / 10);
            ...
            boutonRetour.Position = new Vector2((3 * sexyviolon / 4) - 200, 5 * sexysaxo / 10);
            ...
            boutonFenetre.Position = new Vector2((3*sexyviolon/4) - 200, (5*sexysaxo/10) + 100);
